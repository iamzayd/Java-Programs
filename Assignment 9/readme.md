JDBC Demo This is a Java project that demonstrates how to use JDBC (Java Database Connectivity) to connect to a MySQL database and perform basic CRUD (Create, Read, Update, Delete) operations.
